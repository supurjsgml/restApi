...
public class SwaggerConfig {
    ...
    /**
     * inner class 형식 DTO(1개의 모델 안에 N개 이상의 클래스를 지정한 경우) 사용시 스웨거3 문서의 리턴 타입 중복현상 때문에
     * 리턴타입 다시 커스텀
     * 
    ...
    // originalSchema.get$ref().equals("#/components/schemas/ApiBodyDocumentDTO.Success"))
    // {
    ...
    public OpenAPI openAPI() {
        ...
        return new OpenAPI()
                ...
                .servers(Arrays.asList(apiServer, localServer));
    }
